...
<link rel="stylesheet" type="text/css" href="include/css/icon.css">
<link rel="stylesheet" type="text/css" href="include/css/easyui.css">
...
<body>
	...
	<div class="htmleaf-container">
		...
		<div id="login_form-holder" class="modal-holder">
			...
			<!-- 表单 -->
			<form id="login_form" class="modal" onsubmit="return false;">
              ...
              <use xlink:href="#close-icon"></use>
				...
				<div class="modal__header">欢迎来到新闻管理系统<br/><font style="font-size: 18px">管理员登录</font></div>
				<div class="modal__description"><a href="index.jsp">返回新闻列表页面</a></div>

				<!-- 考号 -->
				<div class="modal__section">
					<div class="input-with-label">
						<input id="uid" type="text" class="input-with-label__input">
						<label for="uid" class="input-with-label__label">请输入管理员账号
				...
				<div class="modal__section">
					<div class="input-with-label">
						<input id="pwd" type="password" class="input-with-label__input">
						<label for="pwd" class="input-with-label__label">请输入密码
							<div class="input-with-label__label__corner"></div>
						</label>
					</div>
				</div>
				<div class="modal__section grid grid--sliced grid--gutter-x2">
					<div class="grid-bit grid-bit--10-20" id="login_submit">
						<button id="login_submit">登录</button>
					</div>
					<div class="grid-bit grid-bit--10-20">
						<a href="#" target="_blank"><button class="button--grey">注册</button></a>
					</div><br/>
					<div class="col-md-12 text-center">
						<p>
						<small><a href="http://maxcj.cn" target="_blank">@May丶乘剑</a></small>
						</p>
					</div>
				</div>
			</form>
	...
	<div style="text-align:center;">
		<div class="row" style="padding-top: 760px; clear: both;">
			<div class="col-md-12 text-center">
				<p>
					<small><a href="http://maxcj.cn" target="_blank">&copy;
							All Rights Reserved. @May丶乘剑</a></small>
				</p>
			</div>
		</div>
	</div>
